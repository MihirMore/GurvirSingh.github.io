   ...
   <body>
        ...
        if(($_GET['login'])){
         ...
         <form action="index.php">
            ...
            <label for="text" style="font-size:32px;color:red;">Error Occured!</label>
            <br/><br/><br/>
            <div class="img">
        ...
        <?php }else{ ?>
         ...
         <form action="index.php">
            <div class="form-group">
            <label for="text" style="font-size:32px;color:red;">Error Occured! You are already Registered! </label>
            <br/><br/><br/>
            <div class="img">
                <img class="img-fluid" src="img/error.png">
            </div>
