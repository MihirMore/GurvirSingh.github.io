...
<div class="container-fluid" style="margin-top:-50px;">
    ...
    <h1 class="display-6" style="font-family: 'Poppins', sans-serif;color:#333;font-size:35px;margin-top:-50px;">Web Dashboard</h1><br/>    
        <div class="row text-center">
            <div class="col" style="">
                <a href="map.php" style="color:#212529;"><div class="container" id="con1" style="height:200px;width:200px;float:right;border-radius:5px;box-shadow:0px 0px 2px black; ">
                <i class="fas fa-map-marked-alt" style="font-size:155px;padding-top:10px;"></i>
                <h5 style="margin-top:5px;">Location</h5></a>
                </div>
            </div>
            <div class="col" style="">
            <a href="log.php" style="color:#212529;"><div class="container" id="con1" style="height:200px;width:200px;float:left;border-radius:5px;box-shadow:0px 0px 2px black; ">
                <i class="fas fa-file-alt" style="font-size:155px;padding-top:10px;"></i>
                <h5 style="margin-top:5px;">Logs</h5></a>
                </div>  
            </div>
            </div>
            ...
            <div class="col" style="">
            <a href="info.php" style="color:#212529;"><div class="container" id="con1" style="height:200px;width:200px;float:right;border-radius:5px;box-shadow:0px 0px 2px black; ">
                <i class="fas fa-info-circle" style="font-size:155px;padding-top:10px;"></i>
                <h5 style="margin-top:5px;">Help</h5></a>
                </div>  
            </div>
            <div class="col" style="">
            <a href="setting.php" style="color:#212529;"><div class="container" id="con1" style="height:200px;width:200px;float:left;border-radius:5px;box-shadow:0px 0px 2px black; ">
                <i class="fas fa-edit" style="font-size:155px;padding-top:10px;"></i>
                <h5 style="margin-top:5px;">Update Info</h5></a>
                </div>  
            </div>
            </div>
...
<?php } else{ header("location:error.php?login=true"); }?>
