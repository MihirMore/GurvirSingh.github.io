        ...
        <div class="container-fluid" style="background-color:white;">
            <div class="jumbotron jumbotron-fluid" style="margin-top:-35px;height:320px;background-color:white">
                <div class="container text-center">
                  <h1 class="display-3" id="delamate_logo" style="font-family: 'Poppins', sans-serif;color:#333;letter-spacing:-7px;"><br/> Hello, <?php echo ucwords($_SESSION['user']);?></h1>
...
<div class="container-fluid" style="margin-top:-50px;">
  <div id="p2">
    <h3><b></b>Smart Vehicle Security and Maintenance System &copy; inc 2018-2019.</b></h3>
  </div>
  <div id="p1">
    <p>For feedback and suggestions please visit the 
      <a href="index.php">home page.</a>
    </p>
    <div class="contact">
      <b style="font-size:25px;">Contact us</b>
    <br/>
    <p>Contact us on our specified email address.
      <br/>Your password will be sent to you by Email after verification.
      <br/>
      <b>Email :</b> <a href="#">support@kgmsecurity.tech</a>
      <br/>
    </p>
    <p></div>Mail us at <a href="#">support@kgmsecurity.tech</a> using your registered email
      <br/></div><br/></p>
  </div>
  </div> 
